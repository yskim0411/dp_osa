...
def train(data, labels, ckpt_path, iterations=100, depth=3, random_state=42):
    model = CatBoostClassifier(iterations=iterations, depth=depth, random_state=random_state, verbose=False)
